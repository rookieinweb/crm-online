  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        a: common_vendor.t(__props.item.product_name || __props.item.name),
        b: common_vendor.t(__props.item.level),
        c: common_vendor.n("level-" + __props.item.level),
        d: common_vendor.t(__props.item.customer_name || __props.item.contactName),
        e: common_vendor.t(__props.item.phone || __props.item.contactPhone),
        f: common_vendor.t(statusInfo.value.label),
        g: statusInfo.value.color,
        h: statusInfo.value.bg,
        i: common_vendor.t(__props.item.fullAddress || __props.item.customer_source || "-"),
